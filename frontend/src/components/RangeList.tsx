                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                    ...
                                    className="bg-background border border-border/50 rounded-lg px-2 py-1.5 text-sm font-mono focus:outline-none focus:ring-1 focus:ring-primary/50 transition-all w-full"
                                />
                            </div>
                            <div className="flex flex-col gap-1.5">
                                <label className="text-[10px] font-medium text-muted-foreground flex items-center gap-1">
